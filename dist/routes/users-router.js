...
exports.usersRouter.post('/', (0, validators_1.default)(validators_1.usersValidators), middleware_1.checkUserCreateMiddleware, controllers_1.usersController.createUser);
...
exports.usersRouter.delete('/:id', (0, middleware_1.authMiddleware)('USER'), (0, validators_1.default)(validators_1.usersValidators), middleware_1.checkUserDeleteMiddleware, controllers_1.usersController.deleteUser);
